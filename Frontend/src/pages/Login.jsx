...
const Login = () => {
  ...
  return (
    <section className='max_padd_container flexCenter flex-col pt-32'>
      ...
      {state==="Sign Up"?<p className='text-black font-bold'>ALready have an accunt?
        <span onClick={() => {setState("Login")}} className='text-secondary underline cursor-pointer'>Login</span>
      </p>:
      <p className='text-black font-bold'>Create an accunt?     
        <span onClick={() => {setState("Sign Up")}} className='text-secondary underline cursor-pointer'>  Sign Up</span>
      </p>}
