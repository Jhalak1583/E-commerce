  ...
  return (
    <section className="relative bg-hero bg-center bg-no-repeat bg-cover h-screen w-full">
      <div className="max_padd_container relative top-32 xs:top-52">
        ...
        <p className="text-gray-50 regular-16 mt-6 max-w-[33rem] ">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est soluta quaerat voluptatum. Excepturi deleniti vitae illo perferendis culpa facere architecto optio consectetur. Veritatis voluptate, cupiditate doloribus consectetur minima repellat iste!</p>
