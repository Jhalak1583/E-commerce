...
const NewLetter = () => {
  return (
    ...
    <section className="max_padd_container py-12 x1:py-28 bg-white"> 
        <div className="mx-auto x1:w-[80%] flexCenter flex-col gap-y-8 w-full max-w-[666px]">
            ...
            <div className="flexBetween rounded-full ring-1 ☐ring-slate-900/5 ☐hover:ring-slate-900/15 bg-primary w-full max-w-[588px]">
                <input type="email" placeholder="Your email address" className="w-full bg-transparent m1-7 border-none outline-none regular-16 "/>
